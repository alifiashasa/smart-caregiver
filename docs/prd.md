...
| :----------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Auth & Onboarding**          |                                                                                                                                                        |
| REQ-001                        | Pengguna dapat mendaftar sebagai _Caregiver_ menggunakan email, kata sandi, dan verifikasi OTP email                                                   |
| REQ-001A                       | _Caregiver_ yang register atau _login_ dengan email dan kata sandi wajib memverifikasi kepemilikan email menggunakan OTP 6 digit yang dikirim melalui email |
...
- _Login_ di luar alur email/kata sandi dan OTP caregiver
...
| :------------------------------------------------------------------------------------------------------------------------------------------------ | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Auth & Onboarding**                                                                                                                             |                                                                                                                                                                                                                                                                                                                 |
| Pengguna dapat mendaftar sebagai _Caregiver_ menggunakan email, kata sandi, dan OTP email                                                         | Pengguna dapat mengakses halaman registrasi. Komponen pada halaman registrasi meliputi: \- Text field Email \- Text field Kata Sandi \- Text field Konfirmasi Kata Sandi \- Button "Daftar" Sistem akan memvalidasi format email dan kecocokan kata sandi. Setelah data valid, sistem membuat akun, membuat OTP 6 digit, menyimpannya dengan masa berlaku beberapa menit, dan mengirimkannya ke email caregiver. Token autentikasi baru diberikan setelah OTP berhasil diverifikasi. |
| _Caregiver_ dapat _login_ menggunakan email, kata sandi, dan OTP email                                                                            | Alur _login_: (1) _Caregiver_ mengirim email dan kata sandi. (2) Jika kredensial valid, sistem membuat OTP 6 digit, menyimpannya dengan masa berlaku beberapa menit, dan mengirimkannya ke email caregiver melalui penyedia email. (3) _Caregiver_ mengirim email dan OTP ke endpoint verifikasi. (4) Jika OTP valid dan belum kedaluwarsa, sistem menandai email sebagai terverifikasi dan mengembalikan token autentikasi. OTP digunakan untuk memverifikasi kepemilikan email caregiver. |
